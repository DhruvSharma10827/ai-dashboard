...
from ai_dashboard.core.logging import initialize_logging
...
from ai_dashboard.styles.theme import ThemeName
from ai_dashboard.styles.theme import get_theme_css
...
class AIDashboardApp(App):
    ...
    def _fix_windows_console(self) -> None:
        ...
        try:
            ...
            # ruff: noqa: SIM115
            # These file handles need to remain open for the TUI lifetime
