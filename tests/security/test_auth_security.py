...
from ai_dashboard.core.exceptions import AuthenticationError, SecurityError
...
class TestInputValidation:
    ...
    def test_sql_injection_prevention(self):
        ...
        from ai_dashboard.utils.validation import validate_model_id, validate_agent_id
    ...
    def test_path_traversal_prevention(self):
        ...
        from ai_dashboard.utils.helpers import truncate_string, safe_get
